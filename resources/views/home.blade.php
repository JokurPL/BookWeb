...
@section('content')
    ...
    <form method="post" action="{{route('books.save')}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input required type="text" class="form-control" name="title" id="title" placeholder="Wpisz nazwę książki">
        </div>
        <div class="form-group">
            <label for="desc">Opis książki</label>
            <textarea required  class="form-control" name="desc" id="desc" placeholder="Wpisz opis książki"></textarea>
        </div>
                <div class="form-group">
                    <label for="categories">Kategoria</label>
                    <select required name="categories_id" class="form-control" id="categories_id">
                ...
                <div class="form-group">
                    ...
                    <select required name="author_id" class="form-control" id="author_id">
                        @foreach($author as $a)
