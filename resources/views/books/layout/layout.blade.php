...
<head>
    ...
    <link href="{{public_path()}}\css\lightbox.css" rel="stylesheet">
    @yield('head-scripts')
</head>
<body>
...
<!-- FOOTER !-->
    <hr>
    <div class="container">
        <p style="float: left;">Wyprodukowane przez: <a href="/">Mateusz Pietrzak</a></p>
        <p class="text-right"> &copy; {{ date('Y')}}</p>
    </div>
...
<script src="{{public_path()}}\js\lightbox.js"></script>
@yield('scripts')
</body>
</html>